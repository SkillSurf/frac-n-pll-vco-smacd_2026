...
F {}
E {}
B 2 1405.3515625 -1264.21875 2205.3515625 -864.21875 {flags=graph
y1=0
y2=1.3
ypos1=0
ypos2=2
...
logy=0
x1=0}
B 2 1355.3515625 -384.21875 2155.3515625 15.78125 {flags=graph
y1=0
y2=8.1e-05
ypos1=0
ypos2=2
...
C {simulator_commands.sym} 170 -290 0 0 {name=bandgap1 only_toplevel=true value="
.control
save all
alter V1 dc 1.2
...
.endc
"}
C {simulator_commands.sym} -110 -270 0 0 {name=MODEL only_toplevel=true

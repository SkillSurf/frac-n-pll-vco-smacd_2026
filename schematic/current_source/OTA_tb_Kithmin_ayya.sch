...
N 635 -940 1190 -940 {lab=VDD}
N 430 -940 635 -940 {
lab=VDD}
N 1190 -400 1190 -310 {lab=GND}
N 1070 -400 1070 -310 {lab=GND}
N 890 -410 890 -360 {lab=VDD}
N 1300 -940 1300 -780 {lab=VDD}
N 1300 -750 1300 -600 {lab=GND}
N 1190 -940 1190 -780 {lab=VDD}
N 1240 -780 1260 -780 {lab=#net6}
N 1190 -730 1240 -730 {lab=#net6}
N 1190 -750 1190 -730 {lab=#net6}
N 1240 -780 1240 -730 {lab=#net6}
N 1230 -780 1240 -780 {lab=#net6}
N -630 -710 -630 -680 {
lab=GND}
N -720 -710 -630 -710 {
lab=GND}
...
N 1070 -510 1070 -430 {lab=Vo1}
N 1190 -730 1190 -430 {lab=#net6}
N 1130 -400 1150 -400 {lab=Vo1}
N 1070 -510 1130 -510 {lab=Vo1}
N 1070 -770 1070 -510 {lab=Vo1}
N 1130 -510 1130 -400 {lab=Vo1}
N 1110 -400 1130 -400 {lab=Vo1}
N 1190 -940 1300 -940 {lab=VDD}
N 800 -770 800 -715 {
lab=#net5}
N 635 -770 800 -770 {
lab=#net5}
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1170 -400 0 0 {name=M11
l=0.13u
w=0.15u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1090 -400 0 1 {name=M10
l=0.13u
w=4u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 1280 -780 0 0 {name=M13
l=0.13u
w=2.5u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 1210 -780 0 1 {name=M12
l=0.13u
w=2.5u
ng=1
m=1
...
C {lab_pin.sym} 280 -435 0 1 {name=p16 sig_type=std_logic lab=GND}
C {lab_pin.sym} -630 -685 0 1 {name=p20 sig_type=std_logic lab=GND}
...
C {lab_pin.sym} 1190 -315 0 1 {name=p23 sig_type=std_logic lab=GND}
C {lab_pin.sym} 1300 -605 0 1 {name=p25 sig_type=std_logic lab=GND}
C {lab_pin.sym} 1070 -765 2 0 {name=p11 sig_type=std_logic lab=Vo1}
